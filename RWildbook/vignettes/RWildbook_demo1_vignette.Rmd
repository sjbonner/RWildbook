...
* Case 1. If you have a search URL on hand then you can run the following code.
...
* Case 3. If you do not have searchURL or the JDOQL query ready for searching the data then you can supply filters based on the variables within the database.
